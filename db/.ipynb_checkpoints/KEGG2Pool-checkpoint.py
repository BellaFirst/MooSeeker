...
class KEGG(object):
    ...
    # =================================================
    def save_my_pool(self, translate=True, file_dir='./MYPOOL/'):
    ...
    def save_MOLFile(self, molfile_dir='./KEGG_Compound_MOLiles/'):
    ...
    def Get_Tanimoto(self, s, p, molfile_dir='/home/cao/phdseeker/db/KEGG_Compound_MOLiles/'):

        if (not os.path.exists(molfile_dir + str(s) + ".mol")) or (not os.path.exists(molfile_dir + str(p) + ".mol")):
            return 0
